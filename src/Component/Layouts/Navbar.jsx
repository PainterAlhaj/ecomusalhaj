...
import { AppBar, Badge, Toolbar, List, ListItemButton, ListItemText, MenuItem, Menu, Drawer, Typography, Button } from "@mui/material";
...
>
  ...
  onClick={(()=>{
    ...
    Shop Layouts 
    <ul className="drawerlist"
style={{display:`${shoplayouttouch?'block':'none'}`}}
>
...
{menu.title}
    ...
    Features
    <ul className="drawerlist"
style={{display:`${featuretouch?'block':'none'}`}}
...
{menu.title}
    ...
    <ul className="drawerlist"
style={{display:`${productstyletouch?'block':'none'}`}}
